...
public class Qr extends javax.swing.JFrame {
    ...
    public static String hacienda;
    public static String fecha;
    public static String semana;
    public static String exportadora;

    public Qr() throws WriterException {
       
        String data = "Productor: "+productor+",\n" 
                + "Hacienda: "+hacienda+" ,\n" 
                + "Fecha: "+fecha+",\n" 
                + "Semana: "+semana+",\n" 
        ...
        BufferedImage imagen = generaQR.crearQR(data, 380, 380);
        ...
        this.setTitle("Generador de código QR");
